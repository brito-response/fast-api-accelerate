...
class Logger:
    """ Logger central da CLI. Desacoplado da regra de negócio."""
    ...
    def _print(self, message: str, level: LogLevel):
        color_map = {LogLevel.INFO: typer.colors.BLUE,LogLevel.SUCCESS: typer.colors.GREEN,LogLevel.WARNING: typer.colors.YELLOW, LogLevel.ERROR: typer.colors.RED,LogLevel.DEBUG: typer.colors.MAGENTA}
